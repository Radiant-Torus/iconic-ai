...
export default function ImmortalGrandmaBlog() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-red-500">
      {/* Header */}
      <header className="bg-gradient-to-r from-purple-600 to-pink-500 border-b border-purple-700 sticky top-0 z-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-purple-500/20 to-pink-500/20 py-20">
